package com.zhuoyu.delivery.masterdata.common.application;
...
@Service
public class MasterDataProjectContextService {

    private final ProjectAccessApplicationService projectAccessApplicationService;

    public MasterDataProjectContextService(ProjectAccessApplicationService projectAccessApplicationService) {
